...
import { generateFAQSchema, generateMetaTags, StructuredData } from "@/lib/seo"
...
export const Route = createFileRoute("/$lang/_public/about")({
  ...
  head: () => ({
    meta: generateMetaTags({
      ...
      keywords:
        "about VNRunner, running platform Vietnam, race registration platform, Vietnamese running community",
  ...
  const faqSchema = generateFAQSchema([
    {
      ...
      answer:
        "VNRunner is Vietnam's premier platform for discovering and registering for running races. We connect runners with race organizers to create memorable racing experiences across Vietnam.",
    },
    {
      question: "How do I register for a race?",
      answer:
        "Browse our race listings, select your preferred event, and complete the online registration form. Payment is processed securely through our platform. You'll receive confirmation and race details via email.",
    },
    {
      question: "Can race organizers use VNRunner?",
      answer:
        "Yes! Race organizers can create and manage races through our intuitive dashboard, process registrations, access participant data, and communicate with runners before and after events.",
    },
    {
      question: "What types of races are available?",
      answer:
        "VNRunner features a variety of races including road races, trail runs, marathons, half marathons, ultramarathons, 5K, 10K events, and more across Vietnam.",
    },
  ])
      ...
      <div className="container">
        ...
        >
          ...
          <header className="space-y-6 text-center">
            ...
            >
              VNRunner is your go-to platform for discovering and registering
              for running races across Vietnam. We connect runners with race
              organizers to create memorable racing experiences.
            </p>
          </header>
          ...
          <Card className="border border-primary/20 bg-gradient-to-br from-card to-card/50 backdrop-blur rounded-2xl">
            ...
            <CardContent className="px-8 pb-8">
              <p className="text-muted-foreground leading-relaxed text-lg">
                ...
                for your first 5K or your tenth marathon, VNRunner helps you
