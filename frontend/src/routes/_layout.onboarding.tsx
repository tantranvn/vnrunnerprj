...
const FITNESS_OPTIONS: {
...
}[] = [
  {
    value: "beginner",
    label: "Beginner",
    description: "New to running, completing 5K–10K events",
  },
  {
    value: "intermediate",
    label: "Intermediate",
    description: "Half marathon ready, regular training",
  },
  {
    value: "advanced",
    label: "Advanced",
    description: "Marathon or ultra experience",
  },
  {
    value: "elite",
    label: "Elite",
    description: "Competitive racer, podium finishes",
  },
]

const DISTANCE_OPTIONS: {
  value: DistancePrefEnum
  label: string
  description: string
}[] = [
...
const TERRAIN_OPTIONS: {
  ...
  { value: "road", label: "Road", description: "Paved streets and city races" },
  {
    value: "trail",
    label: "Trail",
    description: "Mountain paths and nature runs",
  },
